const comments = [
  ...
  {
    'comment': 'Я не знаю что это такое, если бы мы знали что это такое, но мы не знаем, что это такое.',
    'date': 'Mon Sep 26 2022 23:23:39 GMT+0500 (Екатеринбург, стандартное время)',
    'id': 2,
    'rating': 8.9,
    'user': {
      'id': 6,
